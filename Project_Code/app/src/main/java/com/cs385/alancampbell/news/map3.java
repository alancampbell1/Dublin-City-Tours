...
public class map3 extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng Trinity = new LatLng(53.343949, -6.254760);
        mMap.addMarker(new MarkerOptions().position(Trinity).title("Trinity College"));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(Trinity));
    }

    public void nextLocation (View view) {
        Intent startNewActivity = new Intent(this, map4.class);
