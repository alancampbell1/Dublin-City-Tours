...
public class map2 extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng Christchurch = new LatLng(53.343296, -6.271783);
        mMap.addMarker(new MarkerOptions().position(Christchurch).title("Christ Church Cathedral"));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(Christchurch));
    }

    public void nextLocation (View view) {
        Intent startNewActivity = new Intent(this, map3.class);
